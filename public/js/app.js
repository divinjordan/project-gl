...
var _require2 = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/esm-browser/index.js"),
    uuidv4 = _require2.v4;
...
var questionComponent = _objectSpread(_objectSpread({}, questionComponentData), {}, {
  init: function init() {
    var _this = this;

    axios.get("".concat(window.location.origin, "/userCourses")).then(function (res) {
  ...
  formatResponses: function formatResponses() {
    var _this2 = this;

    return this.responses.map(function (element) {
      return {
        id: element.id,
        value: element.text,
        correct: _this2.corrects.includes(element.id + "")
      };
    });
  }
});
...
window.createQuestion = function () {
  return _objectSpread(_objectSpread({}, questionComponent), {}, {
    responses: [{
      id: 0,
      text: "test"
    }],
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 6;
                return axios.get("".concat(window.location.origin, "/questions/").concat(questionId));

              case 6:
                result = _context.sent;
                _this3.question = result.data;
                _this3.questionTitle = _this3.question.question_label;
                _this3.course = _this3.question.course_id;
                _this3.responses = _this3.question.responses.map(function (e) {
                  return {
                    id: e.id,
                    text: e.response_value
                  };
                });
                _this3.oldResponses = _this3.question.responses.map(function (e) {
                  return {
                    id: e.id,
                    value: e.response_value
                  };
                });
                _this3.corrects = _this3.question.responses.filter(function (e) {
                  return e.response_correct;
                }).map(function (e) {
                  return e.id;
                });
                console.log(_this3.corrects);
