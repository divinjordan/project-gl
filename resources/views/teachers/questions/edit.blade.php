<x-app-layout>
    ...
    <div class="p-8 text-gray-900" x-init="init" x-data="editQuestion({{ $question->id }})">
        <div class="rounded-lg shadow-sm bg-white p-8">
            ...
            <div>
                ...
                <div class="mb-4">
                    ...
                    <select x-model="course" class="block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
